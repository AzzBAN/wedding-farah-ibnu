      ...
      <div className="w-full min-h-screen">
        ...
        <div className="relative w-full h-dvh overflow-hidden bg-[#990000]">
          <div className="absolute w-full h-full z-10">
            <div className="absolute w-full z-0 min-[680px]:max-[768px]:max-w-[80%] xl:max-w-[80%]">
              <Background2 height={"100%"} width={"auto"} />
            </div>
            <div className="absolute w-full z-10 min-[680px]:max-[768px]:max-w-[80%] xl:max-w-[80%]">
          ...
          <div className="absolute w-full z-0 aspect-square overflow-hidden min-[680px]:max-[768px]:max-w-[80%] xl:max-w-[80%]">
        ...
        <div className="relative w-full h-dvh overflow-hidden bg-[#990000]">
          <div className="absolute w-full h-full z-10">
            <div className="absolute w-full top-0 right-0 z-0">
              <Background2 height={"auto"} width={"100%"} />
            </div>
          ...
          <div className="absolute w-full z-0 aspect-square ">
            <Image src="/images/content-1.png" alt="placeholder" width={1025} height={1539} className="object-cover absolute -left-15 -top-20 -rotate-12" />
          </div>
        </div>
      </div>
