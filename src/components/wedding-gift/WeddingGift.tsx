    ...
    <>
      <div id="wedding-gift" className="flex flex-col gap-3 justify-center items-center px-7">
        ...
        <button className="hover:cursor-pointer" onClick={handleClick}>
          <div className="w-[40%] min-w-[300px] flex items-center justify-center bg-[#990000]/80 rounded-full py-2 px-5 text-[#F1D6AB] text-[3vw] md:text-[2vw] lg:text-[1.5vw] font-quicksand font-bold hover:bg-[#990000]/50 hover:text-[#990000] transition-all">
            Kirim Kado Online
          </div>
        </button>
      </div>
